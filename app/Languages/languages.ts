...
export const translations: Record<Language, Translations> = {
  'en': {
    ...
    teslaQuestion: 'Tesla stock closes higher than opening prices',
    ...
    inPot: 'in pot',
    noPotsEntered: 'No tournaments entered yet',
    enterPredictionPots: 'Enter prediction tournaments to start competing and making predictions.',
    findPotsToEnter: 'Find Tournaments to Enter',
    ...
    tip2: 'Enter your predictions by the end of the day or week. Tournaments have daily or weekly questions.',
