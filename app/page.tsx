  ...
  return (
    <div className="min-h-screen bg-white text-white">
      ...
      {!isLandingPageLoading && activeSection !== 'comingsoon' && (
        <header
  className={`z-50 bg-white pt-0 md:pt-2 pb-3 md:pb-2 sticky top-0 overflow-x-hidden  ${
...
>
        <div className="relative z-10">
          ...
          {activeSection !== 'comingsoon' && (
            <div className=" mt-1 translate-y-3 md:translate-y-2 pt-1 md:pt-0 px-5 md:px-8 ">
