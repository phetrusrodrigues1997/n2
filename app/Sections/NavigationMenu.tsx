                      ...
                      {supportedLanguages.map((language) => (
                        <button
                          ...
                          className={`w-full flex items-center gap-2 px-3 py-2 text-left hover:bg-gray-50 transition-colors ${
                            currentLanguage === language.code ? 'bg-white text-[#010065]' : 'text-gray-700'
                          }`}
                        >
                          <img
                            src={language.flag}
              ...
              <div className="flex flex-col justify-start px-6 -mt-16">
                ...
                {isConnected && (
                  <button
                    ...
                    className="block w-full text-left py-4 text-lg text-[#010065] hover:text-[#010065] border-t border-gray-100 mt-2"
                  >
                    {t.wallet || "Wallet"}
                  </button>
                )}
                  ...
                  {isConnected && (
                    <>
                      ...
                      <button
                        ...
                        className="block w-full text-left px-4 py-2 text-[#010065] hover:bg-gray-50 hover:text-[#010065]"
                      >
                        {t.wallet || "Wallet"}
                      </button>
                      <button
