            ...
            >
              ...
              <div className="flex items-center justify-between pt-3 ">
                <div className="flex items-center gap-6">
                  ...
                  {/* Likes */}
                  <button className="flex items-center gap-2 text-gray-500 hover:text-[#010065] transition-colors group">
              ...
              <article className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="p-8">
                  <div className="flex items-start gap-6 mb-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="bg-red-100 text-[#010065] px-3 py-1 rounded-full font-semibold text-sm">
                          BREAKING
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-8 pt-4 ">
                    ...
                    <button className="flex items-center gap-3 text-gray-500 hover:text-[#010065] transition-colors group">
