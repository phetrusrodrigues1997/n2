            ...
            {myPots.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="bg-[#010065] text-white py-3 px-6 rounded-lg font-medium hover:bg-gray-800 transition-colors"
                >
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 md:mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-8 md:mt-24 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mb-3">
                <span className="text-[#010065] text-xl">🏆</span>
              </div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#010065] py-4 px-6 rounded-lg text-lg text-white font-medium hover:border-gray-400 hover:bg-gray-500 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isLoadingMyPots ? (
              <>
