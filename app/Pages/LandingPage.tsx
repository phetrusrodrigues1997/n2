                          ...
                          return (isEliminated && userIsParticipant) ? (
                            <div className="absolute bottom-2 left-2 right-2 z-20">
                              <button
                                ...
                                className="w-full group relative overflow-hidden bg-black hover:bg-emerald-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 hover:scale-[1.02]"
                              >
